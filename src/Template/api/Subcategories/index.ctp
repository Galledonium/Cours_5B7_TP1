<?php
$urlToRestApi = $this->Url->build('/admin/subcategories', true);
        ...
        <div class="panel panel-default subcategories-content">
            ...
            <div class="panel-body none formData" id="addForm">
                ...
                <form class="form" id="subcategorieAddForm" enctype='application/json'>
                    ...
                    <a href="javascript:void(0);" class="btn btn-success" onclick="cocktailAction('add')">Add Subcategorie</a>
            ...
            <div class="panel-body none formData" id="editForm">
                ...
                <form class="form" id="categorieEditForm" enctype='application/json'>
                    ...
                    <a href="javascript:void(0);" class="btn btn-success" onclick="cocktailAction('edit')">Update Subcategorie</a>
                ...
                <tbody id="subcategorieData">
                    ...
                    foreach ($subcategories as $subcategorie): $count++;
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" class="glyphicon glyphicon-edit" onclick="editCocktail('<?php echo $subcategorie['id']; ?>')"></a>
                                <a href="javascript:void(0);" class="glyphicon glyphicon-trash" onclick="return confirm('Are you sure to delete data?') ? cocktailAction('delete', '<?php echo $subcategorie['id']; ?>') : false;"></a>
                            </td>
                        </tr>
                        <?php
                    endforeach;
